    ...
    <div className="tech-grid relative flex min-h-screen items-center justify-center overflow-hidden bg-ink-radial px-4">
      ...
      <form onSubmit={handleSubmit} className="glass relative w-full max-w-sm rounded-2xl p-8 shadow-card">
        <div className="mb-6 flex flex-col items-center text-center">
          <Logo size="lg" />
          <h1 className="mt-4 font-display text-2xl font-semibold text-white">Criar conta</h1>
          <p className="text-sm text-slate-400">O primeiro cadastro do sistema vira administrador</p>
        </div>
        ...
        <p className="mt-5 text-center text-xs text-slate-500">
          Já tem conta?{' '}
          <a href="/login" className="font-medium text-brand-300 hover:underline">
            Entrar
          </a>
        </p>
      </form>
