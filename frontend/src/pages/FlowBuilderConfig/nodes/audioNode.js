import { ContentCopy, Delete, MicNone, ArrowForwardIos } from "@mui/icons-material";
...
export default memo(({ data, isConnectable, id }) => {
  ...
  const palette = {
    ...
    subtitle: dark ? "rgba(226, 232, 240, 0.75)" : "rgba(15, 23, 42, 0.75)",
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <MicNone sx={{ width: 16, height: 16, color: "#6366F1" }} />
        </div>
