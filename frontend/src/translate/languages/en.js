    ...
    translations: {
      ...
      whatsappModal: {
        ...
        form: {
          ...
          ratingThanksMessage: "Thank-you message after rating",
          ...
          chatbotHelpTimeCreateNewTicket: "Reopens a recent ticket; use 0 to avoid reusing it.",
          chatbotHelpMaxUseBotQueues: "Limits queue-menu repeats; it does not control FlowBuilder.",
          chatbotHelpTimeUseBotQueues: "Waits this long before repeating the queue menu; 0 disables the wait.",
          chatbotHelpExpiresTicket: "Closes open tickets that remain inactive for this period.",
          chatbotHelpWhenExpiresTicket: "Defines which last message is used to calculate inactivity.",
          chatbotHelpExpiresInactiveMessage: "Sent immediately before automatic closure.",
          chatbotHelpTimeInactiveMessage: "After this period, sends one inactivity message.",
          chatbotHelpInactiveMessage: "Message sent before the final closure timeout.",
          prompt: "Prompt",
        ...
        errorImportOldMessagesLimit:
          "Import is limited to the last {{days}} days.",
        errorImportRangeLimit:
          "The import period cannot exceed {{days}} days.",
      },
      qrCode: {
      ...
      promptModal: {
        form: {
          ...
          max_response_messages: "Maximum messages in Response",
      ...
      contactModal: {
        ...
        form: {
          ...
          extraValue: "Value",
          chatBotContact: "Disable flow",
          termsLGDP: "LGPD terms accepted on:",
          whatsapp: "Source Connection: ",
          document: "ID/Document number",
          address: "Full address",
          contact2: "Secondary contact (phone/WhatsApp)",
          kanbanColumn: "Kanban column",
          fullRegistrationNotice: "This customer's registration is not complete yet. Fill in the fields below and choose the Kanban column before closing the ticket.",
        },
        buttons: {
          addExtraInfo: "Add information",
          okAdd: "Add",
          okEdit: "Save",
          okEditAndClose: "Save and close ticket",
          cancel: "Cancel",
        },
      ...
      queueModal: {
        ...
        form: {
          ...
          timeRotateDefault: "Default (no rotation)",
          greetingMessage: "Greeting message",
          complationMessage: "Completion message",
          outOfHoursMessage: "Out-of-hours message",
          token: "Token",
      ...
      userModal: {
        ...
        form: {
          ...
          canDeleteTickets: "Allow deleting conversation",
          ...
          blockMultipleLogins: "Block Multiple Logins",
        },
        tabs: {
          general: "General",
      ...
      tagModal: {
        ...
        form: {
          name: "Name",
          color: "Color",
          timeLane: "Time to redirect to lane",
          timeLaneUnit: "Unit",
          timeLaneUnitHours: "Hours",
          timeLaneUnitMinutes: "Minutes",
          nextLaneId: "Lane",
      ...
      tickets: {
        ...
        toasts: {
          deleted: "The ticket you were viewing was deleted.",
          bulkDeleted: "{{count}} resolved tickets were deleted.",
          bulkDeletedEmpty: "No resolved tickets were found for the selected filters.",
        },
        notification: {
        ...
        closed: {
          bulkDeleteDescription: "Delete resolved tickets in bulk using period, connection and limit filters.",
          bulkDeleteButton: "Bulk delete",
          bulkDeleteTitle: "Bulk delete resolved tickets",
          bulkDeleteWarning: "Deletion permanently removes the resolved tickets found by the filter.",
          connectionFilter: "Filter by connection",
          dateStart: "Start date",
          dateEnd: "End date",
          limit: "Maximum quantity",
          limitHelp: "Leave blank to delete all tickets found by the filter.",
          confirmBulkDelete: "Delete resolved tickets",
          cancel: "Cancel",
          invalidPeriod: "End date cannot be earlier than start date.",
          dateRequired: "Please provide a start and end date to delete closed tickets.",
          calculateButton: "Calculate total",
          calculating: "Calculating...",
          calculateResult: "{{count}} closed tickets will be deleted with this filter.",
          calculateRequired: "Calculate the total before confirming the deletion."
        },
      },
      transferTicketModal: {
      ...
      mainDrawer: {
        listItems: {
          ...
          settings: "Settings",
          attendanceSchedule: "Attendance Hours",
          files: "File List",
          helps: "Help",
          messagesAPI: "API",
          schedules: "Schedules",
      ...
      quickMessages: {
        ...
        dialog: {
          ...
          edit: "Edit",
          visao: "Allow viewing",
          readOnlyWarning: "This message was created by another user and cannot be edited. Only administrators can edit it.",
        },
        table: {
          shortcode: "Shortcut",
          message: "Message",
      ...
      contactLists: {
        ...
        importSystem: {
          iconTitle: "Import contacts from system",
          title: "Import contacts to list: {{name}}",
          searchPlaceholder: "Search by name or number",
          selectAllFiltered: "Select all filtered contacts",
          selectedCount: "{{selected}} selected from {{total}} contacts",
          loading: "Loading contacts...",
          empty: "No contacts found.",
          importButton: "Import selected",
          toasts: {
            success:
              "Import completed. New: {{imported}} | Duplicates: {{duplicates}} | Invalid: {{invalid}}",
          },
        },
      },
      contactListItems: {
      ...
      announcements: {
        ...
        dialog: {
          ...
          form: {
            ...
            mediaPath: "File",
            status: "Status",
            displayMode: "Announcement type",
            backgroundColor: "Banner background color",
            modes: {
              popover: "Current announcement (bell icon)",
              topbar: "Top banner (top of system)",
            },
            high: "High",
            medium: "Medium",
            low: "Low",
      ...
      schedules: {
        ...
        confirmationModal: {
          ...
          deleteMessage: "This action cannot be undone.",
          cancelTitle: "Are you sure you want to cancel this Schedule?",
          cancelMessage: "The sending will be stopped, but the record will remain in the history.",
        },
        table: {
          contact: "Contact",
          body: "Message",
      ...
      settings: {
        ...
        settings: {
          ...
          customMessages: {
            ...
            AcceptAudioMessageContactMessage: "Message to inform audios are not accepted",
      ...
      messagesList: {
        header: {
          ...
          dialogFarewellSubtitle: "Choose how you want to close this conversation",
      ...
      backendErrors: {
        ...
        ERR_BULK_DELETE_DATE_REQUIRED:
          "Please provide a start and end date to delete closed tickets.",
        ERR_BULK_DELETE_DATE_INVALID: "Invalid date. Please check the selected period.",
        ERR_DUPLICATED_CONTACT: "A contact with this number already exists.",
        ERR_NO_SETTING_FOUND: "No setting found with this ID.",
        ERR_NO_CONTACT_FOUND: "No contact found with this ID.",
        ERR_NO_TICKET_FOUND: "No ticket found with this ID.",
        ERR_NO_USER_FOUND: "No user found with this ID.",
        ERR_USER_HAS_TASKS: "This user has tasks linked to them (as responsible or creator) and cannot be deleted. Reassign or delete the tasks before deleting the user.",
