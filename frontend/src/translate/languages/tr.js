    ...
    translations: {
      ...
      whatsappModal: {
        ...
        form: {
          ...
          ratingThanksMessage: "Değerlendirme sonrası teşekkür mesajı",
          ...
          chatbotHelpTimeCreateNewTicket: "Son ticketı yeniden açar; yeniden kullanmamak için 0 girin.",
          chatbotHelpMaxUseBotQueues: "Sıra menüsü tekrarlarını sınırlar; FlowBuilder'ı kontrol etmez.",
          chatbotHelpTimeUseBotQueues: "Sıra menüsünü tekrarlamadan önce bu süreyi bekler; 0 beklemeyi kapatır.",
          chatbotHelpExpiresTicket: "Bu süre boyunca etkin olmayan açık ticketları kapatır.",
          chatbotHelpWhenExpiresTicket: "Etkinliği hesaplamak için hangi son mesajın kullanılacağını belirler.",
          chatbotHelpExpiresInactiveMessage: "Otomatik kapatmadan hemen önce gönderilir.",
          chatbotHelpTimeInactiveMessage: "Bu sürenin ardından bir etkin olmama mesajı gönderir.",
          chatbotHelpInactiveMessage: "Son kapatma süresinden önce gönderilen mesaj.",
          prompt: "Komut",
        ...
        errorImportOldMessagesLimit:
          "İçe aktarma en fazla son {{days}} gün ile sınırlıdır.",
        errorImportRangeLimit:
          "İçe aktarma aralığı {{days}} günü aşamaz.",
      },
      qrCode: {
      ...
      promptModal: {
        form: {
          ...
          max_response_messages: "Yanıttaki Maksimum Mesaj",
      ...
      contactModal: {
        ...
        form: {
          ...
          extraName: "Alan Adı",
          extraValue: "Değer",
          chatBotContact: "Akışı devre dışı bırak",
      ...
      queueModal: {
        ...
        form: {
          ...
          timeRotateDefault: "Varsayılan (rotasyon yok)",
          greetingMessage: "Karşılama Mesajı",
          complationMessage: "Tamamlama Mesajı",
          outOfHoursMessage: "Çalışma Saati Dışı Mesajı",
          token: "Token",
      ...
      userModal: {
        ...
        form: {
          ...
          canDeleteTickets: "Konuşma silmeye izin ver",
          ...
          blockMultipleLogins: "Coklu Girisleri Engelle",
        },
        tabs: {
          general: "Genel",
          permissions: "İzinler",
      ...
      tickets: {
        ...
        toasts: {
          ...
          bulkDeleted: "{{count}} çözülmüş ticket silindi.",
          bulkDeletedEmpty: "Seçilen filtreler için çözülmüş ticket bulunamadı.",
        },
        notification: {
          message: "Mesaj",
        },
        ...
        buttons: {
          ...
          disableFlow: "Akışı devre dışı bırak",
          scredule: "Randevu",
        ...
        closed: {
          bulkDeleteDescription: "Dönem, bağlantı ve limit filtresiyle çözülen ticketları toplu olarak silin.",
          bulkDeleteButton: "Toplu sil",
          bulkDeleteTitle: "Çözülen ticketları toplu sil",
          bulkDeleteWarning: "Silme işlemi filtrede bulunan çözülmüş ticketları kalıcı olarak kaldırır.",
          connectionFilter: "Bağlantıya göre filtrele",
          dateStart: "Başlangıç tarihi",
          dateEnd: "Bitiş tarihi",
          limit: "Maksimum adet",
          limitHelp: "Filtrede bulunan tüm ticketları silmek için boş bırakın.",
          confirmBulkDelete: "Çözülenleri sil",
          cancel: "İptal",
          invalidPeriod: "Bitiş tarihi başlangıç tarihinden önce olamaz.",
          dateRequired: "Çözülen görüşmeleri silmek için başlangıç ve bitiş tarihi girin.",
          calculateButton: "Toplamı hesapla",
          calculating: "Hesaplanıyor...",
          calculateResult: "Bu filtreyle {{count}} çözülen görüşme silinecek.",
          calculateRequired: "Silme işlemini onaylamadan önce toplamı hesaplayın."
        },
      },
      transferTicketModal: {
      ...
      mainDrawer: {
        listItems: {
          ...
          users: "Kullanıcılar",
          settings: "Ayarlar",
          attendanceSchedule: "Calisma Saatleri",
          files: "Dosya Listesi",
          helps: "Yardım",
          messagesAPI: "API",
      ...
      quickMessages: {
        ...
        dialog: {
          ...
          readOnlyWarning: "Bu mesaj başka bir kullanıcı tarafından oluşturuldu ve düzenlenemez. Sadece yöneticiler düzenleyebilir.",
        },
        table: {
          shortcode: "Kısayol",
          message: "Mesaj",
      ...
      contactLists: {
        ...
        importSystem: {
          iconTitle: "Sistemden kişileri içe aktar",
          title: "Listeye kişi aktar: {{name}}",
          searchPlaceholder: "Ad veya numaraya göre ara",
          selectAllFiltered: "Filtrelenen kişilerin tümünü seç",
          selectedCount: "{{total}} kişiden {{selected}} seçildi",
          loading: "Kişiler yükleniyor...",
          empty: "Kişi bulunamadı.",
          importButton: "Seçilenleri içe aktar",
          toasts: {
            success:
              "İçe aktarma tamamlandı. Yeni: {{imported}} | Yinelenen: {{duplicates}} | Geçersiz: {{invalid}}",
          },
        },
      },
      contactListItems: {
      ...
      kanban: {
        title: "Kanban",
        value: "Deger",
        editValue: "Degeri duzenle",
        clearValue: "Degeri temizle",
        saveValue: "Degeri kaydet",
        valuePlaceholder: "Degeri girin",
        searchPlaceholder: "Ara",
        subMenus: {
          list: "Panel",
          tags: "Şeritler",
      ...
      announcements: {
        ...
        dialog: {
          ...
          form: {
            ...
            status: "Durum",
            displayMode: "Duyuru türü",
            backgroundColor: "Banner arka plan rengi",
            modes: {
              popover: "Mevcut duyuru (zil ikonu)",
              topbar: "Üst banner (sistemin üst kısmı)",
            },
            high: "Yüksek",
            medium: "Orta",
            low: "Düşük",
      ...
      settings: {
        ...
        settings: {
          ...
          customMessages: {
            ...
            AcceptAudioMessageContactMessage: "Sesli mesajların kabul edilmediğini bildirme mesajı",
      ...
      messagesList: {
        header: {
          ...
          dialogFarewellSubtitle: "Bu görüşmeyi nasıl sonlandırmak istediğinizi seçin",
      ...
      backendErrors: {
        ...
        ERR_BULK_DELETE_DATE_REQUIRED:
          "Çözülen görüşmeleri silmek için başlangıç ve bitiş tarihi girin.",
        ERR_BULK_DELETE_DATE_INVALID: "Geçersiz tarih. Lütfen seçilen dönemi kontrol edin.",
        ...
        ERR_USER_HAS_TASKS: "Bu kullanıcıya bağlı görevler var (sorumlu veya oluşturan olarak) ve silinemez. Kullanıcıyı silmeden önce görevleri yeniden atayın veya silin.",
