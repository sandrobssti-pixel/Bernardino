    ...
    translations: {
      ...
      whatsappModal: {
        ...
        form: {
          ...
          ratingThanksMessage: "Mensagem de agradecimento após avaliação",
          ...
          chatbotHelpTimeCreateNewTicket: "Reabre o ticket recente; use 0 para não reutilizá-lo.",
          chatbotHelpMaxUseBotQueues: "Limita repetições do menu de filas; não controla o FlowBuilder.",
          chatbotHelpTimeUseBotQueues: "Aguarda este intervalo para repetir o menu de filas; 0 desativa a espera.",
          chatbotHelpExpiresTicket: "Fecha tickets abertos que permanecerem inativos por este período.",
          chatbotHelpWhenExpiresTicket: "Define qual última mensagem será usada para calcular a inatividade.",
          chatbotHelpExpiresInactiveMessage: "Enviada imediatamente antes do encerramento automático.",
          chatbotHelpTimeInactiveMessage: "Após este tempo, envia uma única mensagem de inatividade.",
          chatbotHelpInactiveMessage: "Mensagem enviada antes do prazo final de encerramento.",
          prompt: "Prompt",
        ...
        errorImportOldMessagesLimit:
          "A importação permite no máximo os últimos {{days}} dias.",
        errorImportRangeLimit:
          "O período de importação não pode ultrapassar {{days}} dias.",
      },
      qrCode: {
      ...
      promptModal: {
        form: {
          ...
          model: "Modelo",
          voice: "Voz",
          max_tokens: "Máx. tokens (resposta)",
          temperature: "Temperatura",
          apikey: "API Key",
          max_messages: "Máx. msgs (histórico)",
          max_response_messages: "Máx. msgs (resposta)",
      ...
      groupManageModal: {
        ...
        form: {
          ...
          newParticipant: "Número (com DDI)",
          noInviteLink: "Nenhum link carregado.",
        },
        admin: {
          admin: "Admin",
          superadmin: "Admin",
        ...
        empty: {
          participants: "Nenhum participante encontrado.",
        },
        notice: {
          notAdmin: "Você não é administrador deste grupo — apenas visualização disponível.",
        },
        buttons: {
          saveInfo: "Salvar nome/descrição",
          promote: "Promover",
          demote: "Rebaixar",
          remove: "Remover",
          add: "Adicionar",
          getLink: "Ver link",
          copyLink: "Copiar",
          newLink: "Gerar novo link",
          close: "Fechar",
        },
        success: {
          infoUpdated: "Grupo atualizado com sucesso!",
          participantsUpdated: "Participantes atualizados!",
          linkRevoked: "Novo link de convite gerado!",
      ...
      contactModal: {
        ...
        form: {
          ...
          extraValue: "Valor",
          chatBotContact: "Desabilitar fluxo",
          termsLGDP: "Termos LGPD aceito em:",
          whatsapp: "Conexão Origem: ",
          document: "CPF ou Identidade",
          address: "Endereço completo",
          contact2: "Contato 2 (telefone/WhatsApp)",
          kanbanColumn: "Coluna do Kanban",
          fullRegistrationNotice: "Este cliente ainda não tem o cadastro completo. Preencha os campos abaixo e escolha a coluna do Kanban para poder fechar o atendimento.",
        },
        buttons: {
          addExtraInfo: "Adicionar informação",
          okAdd: "Adicionar",
          okEdit: "Salvar",
          okEditAndClose: "Salvar e fechar atendimento",
          cancel: "Cancelar",
        },
      ...
      queueModal: {
        ...
        form: {
          ...
          timeRotateDefault: "Padrão (sem rodízio)",
          greetingMessage: "Mensagem de saudação",
          complationMessage: "Mensagem de conclusão",
          outOfHoursMessage: "Mensagem de fora de expediente",
          token: "Token",
      ...
      userModal: {
        ...
        form: {
          ...
          canDeleteTickets: "Permitir excluir conversa",
          ...
          blockMultipleLogins: "Bloquear Múltiplos Logins",
        },
        tabs: {
          general: "Geral",
      ...
      tagModal: {
        ...
        form: {
          name: "Nome",
          color: "Cor",
          timeLane: "Tempo para redirecionar para lane",
          timeLaneUnit: "Unidade",
          timeLaneUnitHours: "Horas",
          timeLaneUnitMinutes: "Minutos",
          nextLaneId: "Lane",
      ...
      tickets: {
        ...
        toasts: {
          ...
          bulkDeleted: "{{count}} atendimentos resolvidos foram excluídos.",
          bulkDeletedEmpty: "Nenhum atendimento resolvido encontrado com os filtros informados.",
        },
        notification: {
          message: "Mensagem de",
        },
        ...
        closed: {
          bulkDeleteDescription: "Excluir atendimentos resolvidos em massa com filtro por período, conexão e limite.",
          bulkDeleteButton: "Excluir em massa",
          bulkDeleteTitle: "Excluir resolvidos em massa",
          bulkDeleteWarning: "A exclusão remove permanentemente os tickets resolvidos encontrados no filtro.",
          connectionFilter: "Filtrar por conexão",
          dateStart: "Data inicial",
          dateEnd: "Data final",
          limit: "Quantidade máxima",
          limitHelp: "Deixe em branco para excluir todos os tickets encontrados no filtro.",
          confirmBulkDelete: "Excluir resolvidos",
          cancel: "Cancelar",
          invalidPeriod: "A data final não pode ser menor que a data inicial.",
          dateRequired: "Informe a data inicial e a data final para excluir os atendimentos resolvidos.",
          calculateButton: "Calcular quantidade",
          calculating: "Calculando...",
          calculateResult: "{{count}} atendimentos resolvidos serão excluídos com este filtro.",
          calculateRequired: "Calcule a quantidade antes de confirmar a exclusão."
        },
      },
      transferTicketModal: {
      ...
      mainDrawer: {
        listItems: {
          ...
          attendanceSchedule: "Horário de Atendimento",
      ...
      quickMessages: {
        ...
        dialog: {
          ...
          readOnlyWarning: "Esta mensagem foi criada por outro usuário e não permite edição. Apenas administradores podem editá-la.",
        },
        table: {
          shortcode: "Atalho",
          message: "Mensagem",
      ...
      contactLists: {
        ...
        importSystem: {
          iconTitle: "Importar contatos do sistema",
          title: "Importar contatos para lista: {{name}}",
          searchPlaceholder: "Buscar por nome ou número",
          selectAllFiltered: "Selecionar todos os contatos filtrados",
          selectedCount: "{{selected}} selecionados de {{total}} contatos",
          loading: "Carregando contatos...",
          empty: "Nenhum contato encontrado.",
          importButton: "Importar selecionados",
          toasts: {
            success:
              "Importação concluída. Novos: {{imported}} | Duplicados: {{duplicates}} | Inválidos: {{invalid}}",
          },
        },
      },
      contactListItems: {
      ...
      kanban: {
        ...
        saveValue: "Salvar valor",
        valuePlaceholder: "Informe o valor",
        searchPlaceholder: "Pesquisa",
        subMenus: {
          list: "Painel",
          tags: "Lanes",
      ...
      announcements: {
        ...
        dialog: {
          ...
          form: {
            ...
            backgroundColor: "Cor de fundo do banner",
            modes: {
              popover: "Informativo",
  ...
  undefined: "Fila não encontrada",
      ...
      schedules: {
        ...
        confirmationModal: {
          ...
          deleteMessage: "Esta ação não pode ser revertida.",
          cancelTitle: "Você tem certeza que quer cancelar este Agendamento?",
          cancelMessage: "O envio será interrompido, mas o registro será mantido no histórico.",
        },
        table: {
          contact: "Contato",
          body: "Mensagem",
      ...
      settings: {
        ...
        settings: {
          ...
          customMessages: {
            ...
            AcceptAudioMessageContactMessage: "Mensagem para informar que não aceita áudios",
      ...
      messagesList: {
        header: {
          ...
          dialogFarewellSubtitle: "Escolha como deseja encerrar esta conversa",
  ...
  confirmationModal: {
    ...
    message: "Esta ação não pode ser revertida.",
      ...
      backendErrors: {
        ...
        ERR_JOB_APPLICATION_INVALID_EMAIL: "Informe um e-mail válido.",
        ERR_JOB_APPLICATION_NOT_FOUND: "Candidatura não encontrada.",
        ERR_JOB_APPLICATION_RESUME_REQUIRED: "Anexe seu currículo para se candidatar.",
        ERR_JOB_APPLICATION_INVALID_FILE_TYPE: "Envie o currículo em PDF ou Word.",
        ERR_JOB_APPLICATION_ALREADY_HIRED: "Esta candidatura já foi efetivada.",
        ERR_JOB_APPLICATION_EMAIL_ALREADY_USER: "Já existe um usuário com este e-mail no sistema.",
        ...
        ERR_WAPP_GROUP_UPDATE_FAILED:
          "Não foi possível atualizar o grupo. Verifique se a conexão é administradora do grupo.",
        ERR_GROUP_ADMIN_REQUIRED:
          "Apenas administradores do grupo podem realizar essa ação.",
        ...
        ERR_WAPP_INVALID_CONTACT: "Este número não está cadastrado no WhatsApp ou é inválido.",
        ...
        ERR_BULK_DELETE_DATE_REQUIRED:
          "Informe a data inicial e a data final para excluir os atendimentos resolvidos.",
        ERR_BULK_DELETE_DATE_INVALID:
          "Data inválida. Verifique o período informado.",
        ERR_DUPLICATED_CONTACT: "Já existe um contato com este número.",
        ERR_NO_SETTING_FOUND: "Nenhuma configuração encontrada com este ID.",
        ERR_NO_CONTACT_FOUND: "Nenhum contato encontrado com este ID.",
        ERR_NO_TICKET_FOUND: "Nenhum tíquete encontrado com este ID.",
        ERR_NO_USER_FOUND: "Nenhum usuário encontrado com este ID.",
        ERR_USER_HAS_TASKS: "Este usuário possui tarefas vinculadas (como responsável ou criador) e não pode ser removido. Reatribua ou exclua as tarefas antes de excluir o usuário.",
