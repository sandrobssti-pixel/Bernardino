    ...
    translations: {
      ...
      whatsappModal: {
        ...
        form: {
          ...
          ratingThanksMessage: "Mensaje de agradecimiento tras la evaluación",
          ...
          chatbotHelpTimeCreateNewTicket: "Reabre el ticket reciente; usa 0 para no reutilizarlo.",
          chatbotHelpMaxUseBotQueues: "Limita repeticiones del menú de colas; no controla FlowBuilder.",
          chatbotHelpTimeUseBotQueues: "Espera este intervalo para repetir el menú de colas; 0 desactiva la espera.",
          chatbotHelpExpiresTicket: "Cierra tickets abiertos que permanezcan inactivos durante este período.",
          chatbotHelpWhenExpiresTicket: "Define qué último mensaje se usa para calcular la inactividad.",
          chatbotHelpExpiresInactiveMessage: "Se envía justo antes del cierre automático.",
          chatbotHelpTimeInactiveMessage: "Después de este período, envía un único aviso de inactividad.",
          chatbotHelpInactiveMessage: "Mensaje enviado antes del plazo final de cierre.",
          prompt: "Prompt",
        ...
        errorImportOldMessagesLimit: "La importación permite como máximo los últimos {{days}} días.",
        errorImportRangeLimit: "El período de importación no puede superar {{days}} días."
      },
      qrCode: {
      ...
      promptModal: {
        form: {
          ...
          max_response_messages: "Máximo de mensajes en la Respuesta",
      ...
      contactModal: {
        ...
        form: {
          ...
          document: "CI o documento de identidad",
          address: "Dirección completa",
          contact2: "Contacto 2 (teléfono/WhatsApp)",
          kanbanColumn: "Columna del Kanban",
          fullRegistrationNotice: "Este cliente todavía no tiene el registro completo. Complete los campos abajo y elija la columna del Kanban antes de cerrar la atención.",
        },
        buttons: {
      ...
      queueModal: {
        ...
        form: {
          ...
          timeRotateDefault: "Predeterminado (sin rotación)",
          greetingMessage: "Mensaje de bienvenida",
          complationMessage: "Mensaje de conclusión",
          outOfHoursMessage: "Mensaje de fuera de horario de atención",
          token: "Token",
      ...
      userModal: {
        ...
        form: {
          ...
          canDeleteTickets: "Permitir eliminar conversación",
          ...
          blockMultipleLogins: "Bloquear inicios múltiples"
        },
        tabs: {
          general: "General",
      ...
      tickets: {
        ...
        toasts: {
          ...
          bulkDeleted: "Se eliminaron {{count}} tickets resueltos.",
          bulkDeletedEmpty: "No se encontraron tickets resueltos con los filtros informados."
        },
        notification: {
          message: "Mensaje de"
        },
        ...
        closed: {
          bulkDeleteDescription: "Elimina tickets resueltos en masa con filtro por período, conexión y límite.",
          bulkDeleteButton: "Eliminar en masa",
          bulkDeleteTitle: "Eliminar resueltos en masa",
          bulkDeleteWarning: "La eliminación quita permanentemente los tickets resueltos encontrados en el filtro.",
          connectionFilter: "Filtrar por conexión",
          dateStart: "Fecha inicial",
          dateEnd: "Fecha final",
          limit: "Cantidad máxima",
          limitHelp: "Déjalo en blanco para eliminar todos los tickets encontrados en el filtro.",
          confirmBulkDelete: "Eliminar resueltos",
          cancel: "Cancelar",
          invalidPeriod: "La fecha final no puede ser menor que la fecha inicial.",
          dateRequired: "Informe la fecha inicial y final para eliminar los atendimientos resueltos.",
          calculateButton: "Calcular cantidad",
          calculating: "Calculando...",
          calculateResult: "{{count}} atendimientos resueltos serán eliminados con este filtro.",
          calculateRequired: "Calcule la cantidad antes de confirmar la eliminación."
        }
      },
      transferTicketModal: {
      ...
      mainDrawer: {
        listItems: {
          ...
          attendanceSchedule: "Horario de atención",
      ...
      quickMessages: {
        ...
        dialog: {
          ...
          readOnlyWarning: "Este mensaje fue creado por otro usuario y no permite edición. Solo los administradores pueden editarlo."
        },
        table: {
          shortcode: "Atajo",
          message: "Mensaje",
      ...
      contactLists: {
        ...
        importSystem: {
          iconTitle: "Importar contactos del sistema",
          title: "Importar contactos a la lista: {{name}}",
          searchPlaceholder: "Buscar por nombre o número",
          selectAllFiltered: "Seleccionar todos los contactos filtrados",
          selectedCount: "{{selected}} seleccionados de {{total}} contactos",
          loading: "Cargando contactos...",
          empty: "No se encontraron contactos.",
          importButton: "Importar seleccionados",
          toasts: {
            success:
              "Importación completada. Nuevos: {{imported}} | Duplicados: {{duplicates}} | Inválidos: {{invalid}}"
          }
        }
      },
      contactListItems: {
      ...
      kanban: {
        ...
        valuePlaceholder: "Informe el valor",
        searchPlaceholder: "Búsqueda",
        subMenus: {
          list: "Panel",
          tags: "Lanes"
      ...
      announcements: {
        ...
        dialog: {
          ...
          form: {
            ...
            mediaPath: "Archivo",
            status: "Estado",
            displayMode: "Tipo de informativo",
            backgroundColor: "Color de fondo del banner",
            modes: {
              popover: "Informativo actual (icono de campana)",
              topbar: "Banner superior (parte alta del sistema)",
            },
            high: "Alta",
            medium: "Media",
            low: "Baja",
  ...
  undefined: "Cola no encontrada",
      ...
      schedules: {
        ...
        confirmationModal: {
          ...
          deleteMessage: "Esta acción no se puede revertir.",
          cancelTitle: "¿Estás seguro de que quieres cancelar este Agendamento?",
          cancelMessage: "El envío será interrumpido, pero el registro permanecerá en el historial."
        },
        table: {
          contact: "Contacto",
          body: "Mensaje",
        ...
        toasts: {
          ...
          cancelled: "Programación cancelada con éxito."
        }
      },
      tags: {
        title: "Tags",
      ...
      settings: {
        ...
        settings: {
          ...
          customMessages: {
            ...
            AcceptAudioMessageContactMessage: "Mensaje para informar que no acepta audios",
      ...
      messagesList: {
        header: {
          ...
          dialogFarewellSubtitle: "Elige cómo deseas finalizar esta conversación",
      ...
      backendErrors: {
        ...
        ERR_BULK_DELETE_DATE_REQUIRED:
          "Informe la fecha inicial y final para eliminar los atendimientos resueltos.",
        ERR_BULK_DELETE_DATE_INVALID: "Fecha inválida. Verifique el período informado.",
        ...
        ERR_USER_HAS_TASKS: "Este usuario tiene tareas vinculadas (como responsable o creador) y no se puede eliminar. Reasigne o elimine las tareas antes de eliminar el usuario.",
