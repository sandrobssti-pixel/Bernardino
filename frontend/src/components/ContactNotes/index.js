...
const useStyles = makeStyles((theme) => ({
    ...
    cancelButton: {
        ...
        fontWeight: 600,
        textTransform: "none",
        background: theme.mode === "light" ? "#e2e8f0" : "rgba(148,163,184,0.32)",
        color: theme.mode === "light" ? "#334155" : "#e2e8f0",
        "&:hover": {
            background: theme.mode === "light" ? "#cbd5e1" : "rgba(148,163,184,0.42)",
        },
    },
    saveButton: {
        position: "relative",
        ...
        color: theme.mode === "light" ? theme.palette.primary.main : "#dbeafe",
        "&:hover": {
            background: theme.mode === "light"
                ? `${theme.palette.primary.main}55`
                : `${theme.palette.primary.main}6a`,
        },
    },
}));
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid xs={12} item>
                                <Grid container spacing={2}>
                                    ...
                                    <Grid xs={6} item>
                                        <ButtonWithSpinner loading={loading} type="submit" variant="text" className={classes.saveButton} autoFocus fullWidth>
                                            Salvar
                                        </ButtonWithSpinner>
                                    </Grid>
                                </Grid>
