...
import webchatIcon from "../../assets/webchat.svg";
...
const getAvatarChannel = (ticket) => {
    ...
    if (channel === "whatsapp_oficial" || channel === "whatsappapi") {
        ...
        <React.Fragment key={ticket.id}>
            ...
            >
                        ...
                        <span className={classes.contactNameWrapper}>
                            ...
                            {ticket.whatsappId && (
                                <div
                                    ...
                                    style={{
                                        backgroundColor: connectionBadgeColor,
                                        color: "#fff",
                ...
                {ticket.useIntegration && (
                    <Tooltip arrow title="IA respondendo">
