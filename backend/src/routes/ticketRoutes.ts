...
ticketRoutes.post("/tickets/closed/bulk-delete/count", isAuth, TicketController.countClosed);
ticketRoutes.post("/tickets/closed/bulk-delete", isAuth, TicketController.bulkDeleteClosed);
