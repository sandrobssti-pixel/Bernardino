...
module.exports = {
  up: async (queryInterface: QueryInterface) => {
    const settings = [
      ...
      { key: "apiTranscription", value: "", companyId: "1" },
      { key: "transcriptionProvider", value: "openai", companyId: "1" },
      { key: "mpaccesstoken", value: "", companyId: "1" } // Placeholder vazio; preencher manualmente se necessário
    ];
