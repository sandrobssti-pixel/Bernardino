...
**Versão atual: 2.3.56 (Etapa 6.21 — Seafile: solução própria tipo "Google Drive" pros arquivos das empresas, rodando em disco local dedicado, com backup automático pro NAS — ver `docs/MANUAL_TECNICO.md`, seção 40)**
