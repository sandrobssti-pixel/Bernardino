...
**Versão atual: 2.3.39 (Etapa 6.4 — Painel Vigia ganhou o card "Fora do expediente", lido direto do módulo Horário de Atendimento já existente (por empresa/fila/conexão) — ver `docs/MANUAL_TECNICO.md`, seção 23)**
